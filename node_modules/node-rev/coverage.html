  ...
  <body>
    ...
    <div id="tests">
      ...
      <div id="filters">
          ...
          <br>
          <input type="checkbox" checked="" onchange="filter(this)" value="node-rev" id="show-node-rev">
          <label for="show-node-rev">node-rev</label>
      </div>
      <table>
          <thead>
          <tr>
          ...
          <tr class="show node-rev success">
              ...
              <td class="test-title">node-rev keeps nested paths even if deeper than one
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr class="hit">
                            ...
                            <td class="source">Object.defineProperty(exports, &quot;__esModule&quot;, {</td>
                        </tr>
                        <tr class="hit">
                        ...
                        <tr class="hit">
                            ...
                            <td class="lint empty"></td>
                            <td class="hits" data-tooltip>1</td>
                            <td class="source">exports.default &#x3D; function (options) {</td>
                        </tr>
                        <tr class="hit">
                        ...
                        <tr class="hit">
                            ...
                            <td class="lint empty"></td>
                            <td class="hits" data-tooltip></td>
                            <td class="source">  var manifest &#x3D; {};</td>
                        </tr>
                        <tr class="hit">
                            <td class="line" data-tooltip>10</td>
                            <td class="lint empty"></td>
                            <td class="hits" data-tooltip></td>
                            <td class="source">  //use assert to require filesPath, outputDir</td>
                        </tr>
                        <tr class="hit">
                        ...
                        <tr class="hit">
                            ...
                            <tr class="chunks">
                                ...
                                <td class="lint empty"></td>
                                <td class="hits" data-tooltip></td>
                                <td class="source"><div>  var outputDir &#x3D; </div><div class="miss true" data-tooltip>options.outputDir</div><div> || </div><div class="miss never" data-tooltip>__dirname</div><div>;</div></td>
                            </tr>
                        <tr class="hit">
                        ...
                        <tr class="hit">
                            ...
                            <td class="lint empty"></td>
                            <td class="hits" data-tooltip></td>
                            <td class="source">  function writeManifest(manifest) {</td>
                        </tr>
                            <tr class="chunks">
                                <td class="line" data-tooltip>19</td>
                                <td class="lint empty"></td>
                                <td class="hits" data-tooltip></td>
                                <td class="source"><div>    if (</div><div class="miss true" data-tooltip>file</div><div>) {</div></td>
                            </tr>
                        <tr class="hit">
                        ...
                        <tr class="hit">
                            ...
                            <tr class="miss">
                                ...
                                <td class="lint empty"></td>
                                <td class="hits" data-tooltip></td>
                                <td class="source" data-tooltip>      _fsExtra2.default.writeFileSync(_path2.default.join(__dirname, &#x27;assets.json&#x27;), JSON.stringify(manifest), &#x27;utf8&#x27;);</td>
                            </tr>
                        <tr class="hit">
                        ...
                        <tr class="hit">
                            ...
                            <td class="lint empty"></td>
                            <td class="hits" data-tooltip></td>
                            <td class="source">    files &#x3D; files.concat(files, _glob2.default.sync(_path2.default.resolve(filePathPart), {}));</td>
                        </tr>
                        <tr class="hit">
